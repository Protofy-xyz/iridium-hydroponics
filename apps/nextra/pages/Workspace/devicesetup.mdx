...
### Fill the parameters
<div>
Name your definition (eg. 'mydefiniton'), select your board (Protofy ESP32 devBoard) and sdk (esphome-arduino)
</div>
### Edit its config
<div>
...
![Protofy](/media/workspace/devicesubsystem.png?raw=true)
</div>
